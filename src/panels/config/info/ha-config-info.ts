      ...
      >
        <div class="content">
          <ha-card outlined class="header">
            <a
              href="https://infinitytech.ltd/"
              target="_blank"
              rel="noreferrer"
            >
              <img src="/static/icons/favicon-1024x1024.png" width="100px" />
            </a>
           
           
            <a
            href="https://www.uxe.ai/"
            target="_blank"
            rel="noreferrer"
          >
            <img src="/static/icons/uxe.svg" width="100px" />
          </a>
          ...
          rel="noreferrer"
        >
          <img src="https://www.digitaldubai.ae/ResourcePackages/Theme/assets/dist/images/logo.svg" width="180px" />
        </a>


            <p>infinity Home Hub</p>
            <p>version :2.15.0</p>
